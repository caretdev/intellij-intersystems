...
class InterSystemsProjectSettingsConfigurable(private val project: Project) : WithProject(project),
    ...
    override fun isModified(): Boolean {
        return settingsPanel!!.isModified(InterSystemsProjectSettings.getStoredSettings(project));
    }
    ...
    override fun reset() {
        settingsPanel!!.setData(InterSystemsProjectSettings.getStoredSettings(project));
    }
